...
#define BOARD_USDHC_CD_GPIO_BASE GPIO3//GPIO2   //党蜊峈迵瞄陑啣蟀諉竘褐眈勤茼
#define BOARD_USDHC_CD_GPIO_PIN 4//28           //党蜊峈迵瞄陑啣蟀諉竘褐眈勤茼
...
#define BOARD_SD_POWER_RESET_GPIO_PIN (23U)//(19U)//党蜊峈迵瞄陑啣蟀諉竘褐眈勤茼
...
#define BOARD_USDHC_SDCARD_POWER_CONTROL(state) \
    (GPIO_PinWrite(BOARD_SD_POWER_RESET_GPIO, BOARD_SD_POWER_RESET_GPIO_PIN, !state))//state))//瞄陑啣迵夥源腔SDK諷秶袨怓眈毀ㄛ秪森涴爵剒猁龰毀
